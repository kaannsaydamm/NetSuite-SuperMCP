...
const mcpScriptObservabilityActions = [
...
const restletScriptObservabilityActions = extractRestletActions(
  scriptObservabilitySource,
...
const scriptObservabilityResult = compareActions(
